...
- Base R [@citeR]
- `astrologer` [@astrologer] (not on CRAN, but can be installed with: `devtools::install_github("sharlagelfand/astrologer")`)
- `beepr` [@beepr]
- `fs` [@fs]
...
`astrologer` is not on CRAN, but can be installed with:`devtools::install_github("sharlagelfand/astrologer")`
```{r}
#| message: false
#| warning: false
