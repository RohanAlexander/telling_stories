...
4. Which two repeated words, for instance in Chapter 3, characterize the advice of @zinsser (pick one)?
    a. Re-write, re-write.
    b. Remove, remove.
    c.  Simplify, simplify.
    d. Less, less.
5. According to Chapter 5 of @zinsser, a writer should never say anything in writing that they wouldn't say in (pick one)?
    a. Private
    b. Public
    c.  Conversation
    d. Speeches
6. According to Chapter 6 of @zinsser, what are the only tools that a writer has (pick one)?
    a. Papers
    b.  Words
    c. Paragraphs
    d. Sentences
...
12. How long should a first draft take to write of a five-to-fifteen-page paper (pick one)?
    a. One hour
    b.  One day
    c. One week
    d. One month
...
22. Please write a new title for the first article from the list of articles at the start of this chapter from *The New Yorker* that you read.
23. Please write a new title for the other article from the list of articles at the start of this chapter from *The New Yorker* that you read.
24. Please write a new four-sentence abstract for @chambliss1989mundanity
25. Please write a new four-sentence abstract for @doll1950smoking.
