...
rubric |>
  filter(!Component %in% c("Data cited","Estimand", "Replication", "Model", "Results", "Discussion", "Enhancements", "Idealized methodology", "Idealized survey", "Pollster review", "Datasheet", "Parquet")) |>
  tt()
```
...
rubric |>
  filter(!Component %in% c("Model", "Enhancements", "Idealized methodology", "Idealized survey", "Pollster review", "Datasheet", "Parquet")) |>
  tt()
```
...
rubric |>
  filter(!Component %in% c("Replication", "Enhancements", "Model", "Idealized methodology", "Idealized survey", "Pollster review")) |>
  tt()
```
...
rubric |>
  filter(!Component %in% c("Replication", "Enhancements", "Idealized methodology", "Idealized survey", "Pollster review")) |>
  tt()
```
...
rubric |>
  filter(!Component %in% c("Replication", "Enhancements", "Idealized methodology", "Idealized survey", "Pollster review", "Datasheet")) |>
  tt()
```
...
- Some dataset ideas:
  - Jacob Filipp's groceries dataset: https://jacobfilipp.com/hammer/. 
  - The IJF procurement dataset (you would then be eligible for the IJF best paper award): https://theijf.org/procurement. 
  - Revisiting a Open Data Toronto dataset (you would then be eligible for the Open Data Toronto best paper award)
  - A dataset from here: https://tellingstorieswithdata.com/23-datasets.html.
