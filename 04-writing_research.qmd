...
5. According to @king2006publication, if our standard error was 0.05 then which of the following specificities for a coefficient would be silly (select all that apply)?
    ...
    g. 3
    h.  2.71828
6. What is one of the critical tasks in the process of writing a paper (pick one)?
...
Use Quarto build up a single PDF over the course of the week. After each day commit and push your work with an informative commit message. Make use of headings and sub-headings to structure your submission. Submit a link to your repo.
