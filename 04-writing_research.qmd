...
- Read *Novelist Cormac McCarthy's tips on how to write a great science paper*, [@Savage2019]
  - *Provides 17 dot points that will improve your writing.*
...
2. Or consider wanting to explore the neonatal mortality rate (NMR), for instance being interested in what NMR could look like in Sub-Saharan Africa in 20 years. This would be questions-first. But then within this, there could be: theory-driven aspects, for instance what do we expect based on biological relationships with other quantities; or data-drive, for instance, let us collect as much data as possible about then create forecasts. An alternative, purely data-driven approach would be having access to NMR and then working out what is possible.
