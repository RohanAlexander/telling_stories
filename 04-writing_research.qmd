...
- Watch *Quantitative Editing*, [@bronnerquantediting]
  - Laura Bronner talks about quantitative-based writing based on her experience as the quantitative editor at FiveThirtyEight.
...
2. Or consider wanting to explore the neonatal mortality rate (NMR), which was introduced in @sec-fire-hose, for instance being interested in what NMR could look like in Sub-Saharan Africa in 20 years. This would be questions-first. But then within this, there could be: theory-driven aspects, for instance what do we expect based on biological relationships with other quantities; or data-driven, for instance, let us collect as much data as possible about then create forecasts. An alternative, purely data-driven approach would be having access to NMR and then working out what is possible.
