...
4. In the context of research approaches, what does data-first mean (pick one)?
...
5. What is a counterfactual (include examples and references and write at least three paragraphs)?
6. What is a counterfactual (pick one)?
...
8. What is an estimand (pick one)? 
...
9. What is an estimator (pick one)? 
    a.  A rule for calculating an estimate of a given quantity based on observed data.
    b. The object of inquiry.
    c. A result given a particular dataset and approach.
10. What is an estimate (pick one)?
    a. A rule for calculating an estimate of a given quantity based on observed data.
    b. The object of inquiry.
    c.  A result given a particular dataset and approach.
11. What is the purpose of Directed Acyclic Graphs (DAGs) (pick one)?
...
12. What is a "confounder" (pick one)?
...
13. According to Chapter 2 of @zinsser, what is the secret to good writing (pick one)?
    ...
    d. Thorough planning.
14. According to Chapter 2 of @zinsser, what must a writer constantly ask (pick one)?
    a. Who am I writing for?
    b.  What am I trying to say?
    c. How can this be rewritten?
    d. Why does this matter?
15. What is one of the critical tasks in the process of writing a paper (pick one)?
...
16. Which of the following is a key benefit of writing for the writer, even when the focus is on the reader (pick one)?
...
17. Which two repeated words, for instance in Chapter 3, characterize the advice of @zinsser (pick one)?
    a. Rewrite, rewrite.
    b.  Simplify, simplify.
    c. Remove, remove.
    d. Less, less.
18. What is the main reason for removing unnecessary words, typos, and grammatical issues from a paper (pick one)?
...
21. What is a common structure for writing an abstract (pick one)?
...
22. Using only the 1,000 most popular words in the English language, according to the [XKCD Simple Writer](https://xkcd.com/simplewriter/), rewrite the abstract of @chambliss1989mundanity so that it retains its original meaning.
23. According to @king2006publication, what is the key task of subheadings (pick one)?
...
25. According to @king2006publication, if our standard error was 0.05 then which of the following specificities for a coefficient would be silly (select all that apply)?
    a.  2.7182818
    b.  2.718282
    c.  2.71828
    d.  2.7183
    ...
    g. 2.7
    h. 3
26. What should be in the model section (pick one)?
...
27. What is purpose of the results section (pick one)?
...
28. What is the purpose of the discussion section (pick one)?
...
29. Why does @Savage2019 recommend asking yourself if it is possible to preserve your original message without that punctuation mark, that word, that sentence, that paragraph or that section (pick one)?
    a. To reduce the possibility of errors.
    b.  To achieve clarity.
    c. To keep the paper short.
30. What are key aspects of the re-drafting process (select all that apply)?
