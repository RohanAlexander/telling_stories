...
Many people made specific suggestions that greatly improved things, and I am grateful to all of them. Leslie Root came up with the idea around 'Oh, you think we have good data on that!'. Ella Kaye suggested, and rightly insisted on, moving to Quarto. Yanbo Tang assisted with Nancy Reid's 'Shoulders of giants' entry. Alison Presmanes Hill provided dataset suggestions and advice. Heath Priston provided assistance with Toronto homelessness data. Jesse Gronsbell gave invaluable suggestions around ethical statistical practice. Chris Warshaw informed me about the survey data available from the Democracy Fund Voter Study Group. Michael Donnelly and Peter Hepburn consistently provided irreplaceable pointers to existing literatures. Zane Schwartz and Tom Cardoso were excellent sources of data and advice from a journalism perspective. Thank you to Chris Maddison and Maia Balint who provided invaluable support and suggested the closing poem.

Thank you to Lauren Kennedy through whose generous sharing of code, data, and countless conversations my thoughts about MRP have developed. Thank you to Hareem Naveed for helpful feedback. Her industry experience was an invaluable resource as I grappled with questions of coverage and focus. Thank you to Michael Chong and Sharla Gelfand for shaping some of the approaches I advocate around the appropriate use of R. All these folks contribute in an enormous way to the spirit of generosity that characterizes the open source programming languages communities this book builds on.
