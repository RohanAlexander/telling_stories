...
The core of this book is centered around Quarto, however its predecessor, R Markdown, has not yet been sunsetted and there is a lot of material available for it. As such, [-@sec-rmarkdown] contains R Markdown  equivalents of the Quarto-specific aspects in @sec-reproducible-workflows. A set of papers is included in [-@sec-papers]. If you write these, you will be conducting original research on a topic that is of interest to you. Although open-ended research may be new to you, the extent to which you are able to: develop your own questions, use quantitative methods to explore them, and communicate your findings, is the measure of the success of this book. [-@sec-interactive-communication] covers aspects such as websites, web applications, and maps that can be interacted with. [-@sec-datasheet] provides an example of a datasheet. [-@sec-sql] gives a brief overview of SQL essentials. 
[-@sec-predictingpythons] provides a discussion of prediction-focused modeling. 
[-@sec-production] considers how to make model estimates and forecasts more widely available. Finally, [-@sec-activities] provides ideas for using this book in class.
:::
