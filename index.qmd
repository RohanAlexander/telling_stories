...
Part V -- Modelling -- begins with exploratory data analysis in @sec-exploratory-data-analysis. This is the critical process of coming to understand the nature of a dataset, but not something that typically finds itself into the final product. In @sec-its-just-a-linear-model the use of linear models to explore data is introduced. @sec-its-just-a-generalized-linear-model then considers generalized linear models, and also goes through moving away from your own computer and toward using the cloud and then discusses deploying models through the use of packages, web applications, and APIs. 
...
Please download R and RStudio onto your own computer. You can download R for free [here](http://cran.utstat.utoronto.ca/), and you can download RStudio Desktop for free [here](https://rstudio.com/products/rstudio/download/#download). Please also create an account on RStudio Cloud [here](https://rstudio.cloud/). This will allow you to run R in the cloud. And download Quarto [here](https://quarto.org/docs/get-started/).
...
Thank you to David Grubbs, Curtis Hill, and the team at CRC Press for publishing this book, and providing invaluable guidance and support. Thank you to Emily Riederer and Isabella Ghement, who thoroughly went through an early draft of this book and provided detailed feedback that improved this book.

Thank you to Kelly Lyons for her support, guidance, mentorship, and friendship. Every day she demonstrates what an academic should be, and more broadly, what one should aspire to be as a person.
...
Thank you to Emily Riederer who went through more chapters than I can count and provided invaluable advice. While her specific suggestions greatly improved things, more broadly her work changed the way I thought about much of the the content of this book.

I was fortunate to have many reviewers who read entire chapters, sometimes two, three, or even more. They very much went above and beyond and provided excellent suggestions for improving this book. For this I am indebted to Taylor Wright and Erik Drysdale.

Many people made specific suggestions that greatly improved things, and I am grateful to all of them. Leslie Root came up with the idea around "Oh, you think we have good data on that!". Ella Kaye suggested, and rightly insisted on, moving to Quarto. Yanbo Tang assisted with Nancy Reid's "Shoulders of giants" entry. Radu Craiu ensured sampling was afforded its appropriate place. Alison Presmanes Hill suggested Wordbank. Heath Priston provided assistance with Toronto homelessness data. Jesse Gronsbell gave invaluable suggestions around ethical statistical practice. Chris Warshaw suggested the Democracy Fund Voter Study Group survey data. Michael Donnelly, Peter Hepburn, and Léo Raymond-Belzile provided pointers to classic papers that I was unaware of, in political science, sociology, and statistics, respectively. Zane Schwartz and Tom Cardoso were excellent sources of data put together by journalists. Finally, Chris Maddison and Maia Balint suggested the closing poem.

Thank you to Lauren Kennedy through whose generous sharing of code, data, and countless conversations my thoughts about MRP have developed. Thank you to Hareem Naveed for helpful feedback and sharing her industry experience. Thank you to Michael Chong and Sharla Gelfand for shaping some of the approaches I advocate around the appropriate use of R. All these people contribute to the spirit of generosity that characterizes the open source programming languages communities this book builds on.
...
This book has greatly benefited from the notes and teaching materials of others that are freely available online, including: Chris Bail, Scott Cunningham, Andrew Heiss, Lisa Lendway, Grant McDermott, Nathan Matias, David Mimno, and Ed Rubin. Thank you to these people. The changed norm of academics making their materials freely available online is a great one and one that I hope the free online version of this book, available [here](https://tellingstorieswithdata.com/), helps contribute to.

Thank you to Samantha-Jo Caetano and Liza Bolton, who helped develop some of the assessment items, and more generally developed my ideas around how the material covered in this book should be taught. And also, to Lisa Romkey and Alan Chong who allowed me to adapt some aspects of their rubric. The catalysts for aspects of the @sec-on-writing tutorial were @draftnumberfour [p. 186] and Chelsea Parlett-Pelleriti. The idea behind the @sec-interactive-communication tutorial was work by Mauricio Vargas Sepúlveda ("Pachá") and Andrew Whitby. Damien Patrick Williams came up with the idea behind the ChatGPT question in @sec-farm-data.
...
Thank you to those who identified specific improvements, including: Aaron Miller, Amy Farrow, Arsh Lakhanpal, Cesar Villarreal Guzman, Flavia López, Hong Shi, John Hayes, Laura Cline, Lorena Almaraz De La Garza, Mounica Thanam, Reem Alasadi, Wijdan Tariq, Yang Wu, and Yewon Han. 

As at Christmas 2021 this book was a disparate collection of partially completed notes. Thank you to Mum and Dad, who dropped everything and came over from the other side of the world for two months to give me the opportunity to re-write it all and put together a cohesive draft... and again in Christmas 2022, when it turned out that there was a big difference between a cohesive draft and a final draft.
