...
Thank you to David Grubbs and the team at CRC Press for publishing this book, and providing invaluable guidance and support.
...
Many people made specific suggestions that greatly improved things, and I'm grateful to all of them. Leslie Root came up with the idea around 'Oh, you think we have good data on that!'. Ella Kaye suggested, and rightly insisted on, moving to Quarto. Yanbo Tang assisted with Nancy Reid's 'Shoulders of giants' entry. Alison Hill made dataset suggestions and advice. Heath Priston provided assistance with Toronto homelessness data. Jesse Gronsbell gave invaluable suggestions around ethical statistical practice. Chris Warshaw suggested the survey data available from the Democracy Fund Voter Study Group.
...
Thank you to Chris Maddison and Maia Balint who provided invaluable assistance and critically, suggested the closing poem.
...
<!-- A - ethics, Faria - focused on student needs, Keli - NLP, Paul - visualisation, Thomas - SQL. -->

Thank you to those who identified specific improvements, including: Aaron Miller, Amy Farrow, Arsh Lakhanpal, Cesar Villarreal Guzman, Flavia López, Hong Shi, John Hayes, Laura Cline, Lorena Almaraz De La Garza, Mounica Thanam, Reem Alasadi, Wijdan Tariq, Yang Wu, and Yewon Han. Zane Schwartz and Tom Cardoso were excellent sources of data and advice.
