...
This book is structured around a dense 12-week course. It provides enough material for advanced readers to be challenged, while establishing a core that all readers should master. Typical courses that I teach cover the material through to @sec-its-just-a-linear-model, and then pick another couple of chapters that are of particular interest. But it depends on the backgrounds and interests of the students.^[A note to instructors: Provided that Part I "Foundations" is covered, the rest of the chapters are fairly independent. I have found that students sometimes take a while to get started, and that the first three chapters, especially if R is new to them, sometimes take longer than three weeks. Typically, somewhere between the first and second papers is where it all starts to come together, and it is important that the first paper is returned quickly to students so they know where to improve.]
...
This book was primarily written on the traditional lands of the Mississaugas of the Credit, the Huron-Wendat, and the Seneca. Data have long been used to oppress and harm, and the acknowledgement of the history of this land serves as a reminder of the need to work in an ethical way.
...
Thank you to those who identified specific improvements, including: Aaron Miller, Amy Farrow, Arsh Lakhanpal, Cesar Villarreal Guzman, Flavia López, Hong Shi, John Hayes, Laura Cline, Lorena Almaraz De La Garza, Matthias Berger, Mounica Thanam, Reem Alasadi, Wijdan Tariq, Yang Wu, and Yewon Han. 
