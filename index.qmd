...
["Prediction"](https://tellingstorieswithdata.com/27-prediction.html) goes through prediction-focused modeling. 
...
::: {.content-visible unless-format="pdf"}
If you do not have a programming language, then R is a great one to start with. Please do go through [Online Appendix -@sec-r-essentials].
:::
