...
Many people made specific suggestions that greatly improved things, and I am grateful to all of them. Leslie Root came up with the idea around "Oh, you think we have good data on that!". Ella Kaye suggested, and rightly insisted on, moving to Quarto. Yanbo Tang assisted with Nancy Reid's "Shoulders of giants" entry. Radu Craiu ensured sampling was given appropriate importance. Alison Presmanes Hill provided suggestions and advice about Wordbank. Heath Priston provided assistance with Toronto homelessness data. Jesse Gronsbell gave invaluable suggestions around ethical statistical practice. Chris Warshaw suggested the Democracy Fund Voter Study Group survey data. Michael Donnelly and Peter Hepburn provided many pointers to existing literatures. Zane Schwartz and Tom Cardoso were excellent sources of data and advice from a journalism perspective. Finally, Chris Maddison and Maia Balint provided invaluable support and suggested the closing poem.
