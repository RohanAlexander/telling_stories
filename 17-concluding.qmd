...
We do not have a good understanding how much data cleaning and preparation is driving estimates.\index{data!cleaning} @huntington2021influence, and @breznau2022observing, among others, showed that hidden research decisions have a big effect on subsequent estimates, sometimes greater than the standard errors. There has been much exploration of the modeling aspect, but we need much more investigation of how the earlier stages of the data science workflow affect the conclusions. More specifically, we need to look for key points of failure and understand the ways in which failure can happen.\index{data!cleaning}
...
One of the crowning achievements of biology is the binomial nomenclature,\index{binomial nomenclature} which is the formal systematic approach to names, established by Carolus Linnaeus,\index{Linnaeus, Carolus} the eighteenth-century physician [@morange, p. 81]. Each species is referred to by two words with Latin grammatical form: the first is its genus, and the second is an adjective to characterize the species. Standardized nomenclature remains a concern, and the use of nomenclature committees by researchers is recommended [@McCarthy2023]. As discussed in @sec-clean-and-prepare, names are a large source of friction in data science, and a standardized approach is similarly needed in data science.\index{names}\index{efficiency!naming}
...
Considerable innovation in data science occurs in industry, and yet sometimes this knowledge cannot be shared, and when it can it tends to be done slowly. The term data science has been used in academia since the 1960s, but it is because of industry that it has become popular [@Irizarry2020Role].\index{data science!industry} 
...
This book has covered much ground, and while we are toward the end of it, as the butler Stevens is told in the novel *The Remains of the Day* [@ishiguro]:\index{Ishiguro, Kazuo!The Remains of the Day}
