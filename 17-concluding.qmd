...
One of the crowning achievements of biology is the binomial nomenclature.\index{binomial nomenclature} This is the formal systematic approach to names, established by Carolus Linnaeus,\index{Linnaeus, Carolus} the eighteenth-century physician [@morange, p. 81]. Each species is referred to by two words with Latin grammatical form: the first is its genus, and the second is an adjective to characterize the species. Ensuring standardized nomenclature is given active consideration in biology. For instance, the use of nomenclature committees by researchers is recommended [@McCarthy2023]. As discussed in @sec-clean-and-prepare, names are a large source of friction in data science, and a standardized approach is similarly needed in data science.\index{names}\index{efficiency!naming}
