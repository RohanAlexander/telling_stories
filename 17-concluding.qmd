...
We do not have a good understanding how much data cleaning and preparation is driving estimates.\index{data!cleaning} @huntington2021influence, and @breznau2022observing, among others, showed that hidden research decisions have a big effect on subsequent estimates, sometimes greater than the standard errors. There has been much exploration of the modelling aspect, but we need much more investigation of how the earlier stages of the data science workflow affect the conclusions. More specifically, we need to look for key points of failure and understand the ways in which failure can happen.\index{data!cleaning}
