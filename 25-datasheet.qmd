...
# Datasheets {#sec-datasheet}

In @sec-store-and-share we introduced the notion of a datasheet and explained why they are so important. Here we provide an example of one that underpins @citeaustralianpoliticians.
