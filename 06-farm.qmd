...
1. *(Plan)* Consider the following scenario: *Every day for a year three friends record the amount of snow that fell that day in the different cities they each live in.* Please sketch what that dataset could look like and then sketch a graph that you could build to show all observations.
