...
- Watch *Introduction to Sampling and Randomization*, [@register2020sampling]
  - *Provides an overview of sampling approaches with helpful examples.*
- Read *Working-Class Households in Reading*, [@bowley1913working]
  - *Discusses a survey conducted in the UK in the early 1900s, including a particularly informative discussion of systematic sampling.*
- Read *On the Two Different Aspects of the Representative Method*, Parts I "Introduction", III "Different Aspects of the Representative Method", V "Conclusion" and Bowley's discussion, [@neyman1934two]
  - *Provides an overview of stratified sampling.*
- Read *Guide to the Census of Population*, Chapter 10 "Data quality assessment", [@statcanhistory]
  - *Describes and addresses a number of concerns that we have with any survey.*
- Read *He, she, they: Using sex and gender in survey adjustment*, [@kennedy2020using]
  - *Describes challenges, and makes suggestions for ways forward, when considering sex and gender in surveys.*
...
Such error can be particularly pervasive when an enumerator fills out the survey form on behalf of the respondent. And this especially manifests itself when there are racial differences. For instance, @davis1997nonrandom [p. 177] describes how Black people in the US may limit the extent to which they describe their political and racial belief to White interviewers.
