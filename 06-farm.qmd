...
9. What is censored data (pick one)?
    a. Data that have been corrupted and is unreadable.
...
25. What is a target population (pick one)?
    a.  The entire group about which the researcher wants to draw conclusions.
...
44. From @neyman1934two, what is the primary goal of stratified sampling (pick one)?
...
46. From @neyman1934two, what is one advantage of stratified sampling over simple random sampling (pick one)?
    a. It eliminates the need for a sampling frame.
    b. It requires fewer samples.
    c. It is cheaper.
    d.  It may increase the precision of estimates.
47. From @neyman1934two [Section V], which approach allows a consistent estimate of the average collective character of a population, whatever the properties of the population (pick one)?
    a.  Random sampling.
