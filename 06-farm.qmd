...
We can explore some data on languages spoken in Canada from the 2016 Census using `canlang` [@canlang]. This package is not yet available on CRAN,\index{CRAN} and so we install it from GitHub,\index{packages!GitHub installation} using `devtools` [@citeDevtools]. 
