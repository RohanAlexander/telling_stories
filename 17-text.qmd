...
Text modelling is an exciting area of research. But, and this is true more generally, but especially in the case of text, the cleaning and preparation aspect is at least as difficult as the modelling. We will cover some essentials and provide a foundation that can be built on.
...
Stop words are words such as "the", "and", and "a". For a long time such words were thought to not convey much meaning, and there was often a memory of computation constraint. So a common part of preparing a text dataset was to remove them. We now know that stop words can have a great deal of meaning [@schofield2017]. The decision to remove them is a nuanced one that depends on circumstances.
