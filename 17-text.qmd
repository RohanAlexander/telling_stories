...
In that case, we knew what the tuples were. But it might be that we were not sure what the common tuples were in the corpus. We could then use `tokens_ngrams()` to identify them. We could ask for, say, all bi-grams in an exerpt from the book "Don Quixote".
...
don_q_text <- tibble(book = "Don Quixote", 
...
don_q_corpus <-
  corpus(don_quixote_text, docid_field = "book", text_field = "text")
