...
![Quick sketch of a dataset that could be useful for analyzing Australian elections](figures/number_of_seats_redux.png){#fig-australiaexample-data width=45%}
...
raw_elections_data <- 
  read_csv(
    file =
      "https://tallyroom.aec.gov.au/Downloads/HouseMembersElectedDownload-27966.csv",
...
The names are faster to type because R Studio will auto-complete them. To do this, we begin typing the name of a column and then use 'tab' to complete it.
...
Ross took a PhD in Statistics from the University of California, Berkeley, in 1985, then moved to the University of Auckland where he remained for his entire career. He was awarded the Pickering Medal in 2008 by the Royal Society of New Zealand Te Apārangi.
:::
...
simulated_occupancy_data <- 
  tibble(
    ...
    shelter = c(rep(x = "Shelter 1", times = 365), 
