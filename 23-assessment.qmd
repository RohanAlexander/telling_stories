...
rubric |>
  filter(!Component %in% c("Estimand", "Replication", "Model", "Results", "Discussion", "Enhancements", "Survey", "Datasheet")) |>
  gt()
```
...
[Christina Wei](inputs/pdfs/paper-1-Christina_Wei.pdf), 
...
[Morgaine Westin](inputs/pdfs/paper_one-2021-Morgaine_Westin.pdf), 
