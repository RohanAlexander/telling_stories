...
rubric |>
  filter(!Component %in% c("Estimand", "Replication", "Model", "Results", "Discussion", "Enhancements", "Idealized methodology", "Idealized survey", "Pollster methodology overview and evaluation", "Datasheet", "Parquet")) |>
  gt()
```
