...
rubric |>
  filter(!Component %in% c("Class paper", "Estimand", "Replication", "Model", "Results", "Discussion", "Enhancements", "Survey", "Datasheet", "Parquet", "Prose overweighted", "Measurement overweighted")) |>
  gt()
```
...
rubric |>
  filter(!Component %in% c("Model", "Enhancements", "Survey", "Datasheet", "Parquet", "Prose", "Measurement")) |>
  gt()
```
...
rubric |>
  filter(!Component %in% c("Replication", "Enhancements", "Model", "Datasheet", "Parquet", "Prose overweighted", "Measurement overweighted")) |>
  gt()
```
...
rubric |>
  filter(!Component %in% c("Replication", "Enhancements", "Model", "Survey", "Measurement overweighted")) |>
  gt()
```
...
- You are welcome to use this [starter folder](https://github.com/RohanAlexander/starter_folder).
- Submit a PDF of the paper. 
- There should be no evidence that this is a class paper.
...
rubric |>
  filter(!Component %in% c("Replication", "Enhancements", "Survey", "Prose overweighted", "Measurement overweighted")) |>
  gt()
```
...
rubric |>
  filter(!Component %in% c("Replication", "Enhancements", "Survey", "Datasheet", "Prose overweighted", "Measurement overweighted")) |>
  gt()
```
...
rubric |>
  filter(!Component %in% c("Replication", "Survey", "Datasheet", "Prose overweighted", "Measurement overweighted")) |>
  gt()
```
