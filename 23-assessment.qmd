...
rubric |>
  filter(!Component %in% c("Data are appropriately cited","Estimand", "Replication", "Model", "Results", "Discussion", "Enhancements", "Idealized methodology", "Idealized survey", "Pollster methodology overview and evaluation", "Datasheet", "Parquet")) |>
  gt()
```
...
rubric |>
  filter(!Component %in% c("Model", "Enhancements", "Idealized methodology", "Idealized survey", "Pollster methodology overview and evaluation", "Datasheet", "Parquet")) |>
  gt()
```
...
rubric |>
  filter(!Component %in% c("Replication", "Enhancements", "Model", "Idealized methodology", "Idealized survey", "Pollster methodology overview and evaluation")) |>
  gt()
```
...
rubric |>
  filter(!Component %in% c("Replication", "Enhancements", "Idealized methodology", "Idealized survey", "Pollster methodology overview and evaluation")) |>
  gt()
```
...
rubric |>
  filter(!Component %in% c("Replication", "Enhancements", "Idealized methodology", "Idealized survey", "Pollster methodology overview and evaluation", "Datasheet")) |>
  gt()
```
...
rubric |>
  filter(!Component %in% c("Replication", "Idealized methodology", "Idealized survey", "Pollster methodology overview and evaluation", "Datasheet")) |>
  gt()
```
