...
As a second, and more involved, example of EDA we use `opendatatoronto` [@citeSharla], introduced in @sec-fire-hose, and the `tidyverse` [@tidyverse] to obtain and explore data about the Toronto\index{Canada!Toronto} subway system\index{Canada!Toronto subway delays}. We are especially interested in getting a sense of the delays that have occurred.
