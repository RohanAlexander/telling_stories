...
- Read *The Future of Data Analysis*, Part 1 "General Considerations", [@tukey1962future]
  - *John Tukey, the twentieth century statistician, made a variety of contributions to statistics, and this chapter is a masterclass, well ahead of its time, about learning from data.*
- Read *R for Data Science*, Chapter 12 "Exploratory data analysis", [@r4ds]
  - *Provides a self-contained EDA worked example.*
