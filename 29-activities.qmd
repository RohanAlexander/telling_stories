...
- Use the starter folder and create a new repo. Add a link to the GitHub repo in the class' shared Google doc.
...
- Use the starter folder and create a new repo. Add a link to the GitHub repo in the class' shared Google doc. Do all the following in `paper.qmd`.
