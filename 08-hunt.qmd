...
And with regard to gender, they recommend a multi-question approach. First, 
...
And finally, "Just to confirm, you were assigned {FILL} at birth and now you describe yourself as {FILL}. Is that correct?" with possible answers: "Yes"; and "No".
...
At this point we want to clean up a few issues. For instance, for simplicity, remove anyone not voting for Trump or Biden, and create the dependent variables that we will use in @sec-multilevel-regression-with-post-stratification.
...
We will draw on this dataset in @sec-multilevel-regression-with-post-stratification. So we will also save it. 
