...
1. In your own words, what is the fundamental problem of causal inference, being sure to include an example (write two or three paragraphs)?
2. In your own words, what is a counterfactual, being sure to include an example (write two or three paragraphs)?
3. In your own words, what is the role of randomization in constructing a counterfactual (write two or three paragraphs)?
...
7. In the context of randomization, what does stratification mean to you (write a paragraph or two)?
8. How could you check that your randomization had been done appropriately (write two or three paragraphs)?
9. Identify three companies that conduct A/B testing commercially and write one paragraph for each of them about how they work and the trade-offs involved.
...
14. What is a parameter (pick one)?
    ...
    c. The result.
    d. Unknown numbers that determine a statistical model.
15. @ware1989investigating [p. 298] mentions 'a randomized play the winner design'. What is it?
16. @ware1989investigating [p. 299] mentions 'adaptive randomization'. What is it, in your own words?
...
18. @ware1989investigating [p. 300] mentions 'equipoise'. In your own words, please define and discuss it, using an example from your own experience.
