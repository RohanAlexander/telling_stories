...
statements_of_interest <-
  tibble(
    address =
      c("https://www.rba.gov.au/publications/smp/2021/nov/pdf/00-overview.pdf",
...
url <- paste0("https://population.un.org/dataportalapi/api/v1",
