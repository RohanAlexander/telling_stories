...
raw_dhs_data <-
  purrr::pmap_dfr(summary_tfr_dataset |>
...
text <- tesseract::ocr(here::here("jane_scan.png"),
...
text <- ocr(here::here("figures/jane_scan.png"),
            engine = tesseract("eng"))
cat(text)
```
