...
dhs_2000 <-
  ...
  slice(summary_tfr_dataset$page[1]) |>
  separate_rows(raw_data, sep = "\\n", convert = FALSE) |> # ISSUE: needs to be applied to inner tibble, not outer?
  separate(
    col = raw_data,
    into = c("state", "data"),
    sep = "\\.{2,}",
