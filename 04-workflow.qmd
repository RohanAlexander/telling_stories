...
We need to download Quarto from [here](https://quarto.org/docs/get-started/). Or if using RStudio Cloud then it is already built in.

We can create a new Quarto document within RStudio ("File" -> "New File" -> "Quarto Document...").
