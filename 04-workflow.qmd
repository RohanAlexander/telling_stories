...
```{verbatim, file="inputs/quarto_example-figures_crossreferences.qmd"}
```
...
#| fig-subcap: ["Number of illnesses","Number of visits to the doctor"]
#| layout-ncol: 2
...
```{verbatim, file="inputs/quarto_example-tables_crossreferences.qmd"}
```
...
```{verbatim, file="inputs/quarto_example-equations_crossreferences.qmd"}
```

For instance, we then use `@eq-macroidentity` to produce @eq-macroidentity.
