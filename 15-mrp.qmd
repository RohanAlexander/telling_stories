...
In this simulated example, we will just take a 1 per cent sample from the population and use that as our post-stratification dataset. We want to remove tea preferences from that, because that is what we are pretending we do not know. 
