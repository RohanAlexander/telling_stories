...
There are many interesting aspects that we may like to communicate to others. For instance, we may like to show how the model is affecting our estimates of the results. We can make a graph that compares the raw estimates and the raw estimates from the biased survey sample with the model estimates (@tbl-resultsforaustraliaa). Note the skew in favor of the ALP in the biased sample estimates, and how the model is able to correct for this in most cases.

```{r}
#| label: tbl-resultsforaustraliaa
#| tbl-cap: "Comparing MRP estimates with raw estimates"
...
#| fig-cap: "Posterior predictive check and comparing the posterior with the prior"
...
#| tbl-cap: "Comparing the MRP estimates with the Nationscape raw data"
#| message: false
