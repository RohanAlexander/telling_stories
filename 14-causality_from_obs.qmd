...
There are two situations where data can trick us that are so common that we will explicitly go through them. These are: 1) Simpson's paradox,\index{Simpson's paradox} and 2) Berkson's paradox.\index{Berkson's paradox} It is important to keep these situations in mind, and the use of DAGs can help identify them. 
...
We cover propensity score matching because it is widely used. But there are many issues with propensity score matching that mean that humility is needed [@king2019propensity]. These include:\index{propensity score matching!concerns}
