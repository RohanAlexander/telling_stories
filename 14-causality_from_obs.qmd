...
simulated_diff_in_diff <-
  tibble(
    ...
    treat_group = 
      rep(sample(x = 0:1, size = 1000, replace = TRUE ), times = 2)
    ) |>
  mutate(
...
ave_diff <-
  ...
  # Average difference between old and new racket serve
  # speed within groups
...
In this case study we introduce @angelucci2019newspapers. They are interested in understanding the effect of the introduction of television on French newspapers. We will replicate one of the main findings.\index{France!newspaper prices} 
...
newspapers <-
  newspapers |>
  select(year, id_news, after_national, local, national, 
         ra_cst, ps_cst, qtotal) |> 
