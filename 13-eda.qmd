...
Finally, it is especially important to understand the behavior of these key summary statistics at the limits. In particular, one approach is to randomly remove some observations and compare what happens to them.
...
# WHAT IS HAPPENING HERE? REWRITE THIS OMG
...
**NEED TO FILTER TO JUST THE BIG ONES TO SEE THIS**

From this we can see that the 450 minute delay was due to "Transit Control Related Problems", the 446 minute delay was due to "Miscellaneous Other", they seem to be outliers, even among the outliers.
