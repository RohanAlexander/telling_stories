...
One tool that may help is the [SelectorGadget](https://rvest.tidyverse.org/articles/articles/selectorgadget.html). This allows us to pick and choose the elements that we want, and then gives us the input for `html_element()` (@fig-selectorgadget).
...
In this case there are many columns that we do not need, and many duplicated rows.
