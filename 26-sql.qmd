...
1. Please submit a screenshot of you getting at least 70 per cent in the free w3school SQL Quiz available [here](https://www.w3schools.com/quiztest/quiztest.asp?qtest=SQL). You may like to go through their tutorial [here](https://www.w3schools.com/sql/default.asp). But the SQL content in this chapter is sufficient to get 70 per cent. Your screenshot must include the time and date i.e. take a screenshot of your whole screen, not just the browser.
