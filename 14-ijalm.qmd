...
dups_and_letters_shakespeare <-
  c(
    2270, 4774, 5137, 9077, 10606, 12578, 22791, 23041, 
    23042, 23043, 23044, 23045, 23046, 28334, 45128,
    47518, 47715, 47960, 49007, 49008, 49297, 50095, 50559
  )
...
dups_and_letters_dickens <-
  c(
    ...
    47529, 47530, 47531, 47534, 47535, 49927, 50334
  )

books <-
  gutenberg_works(
    author %in% c("Austen, Jane",
                  "Shakespeare, William",
                  "Brontë, Charlotte"),
    !gutenberg_id %in% c(
      dups_and_letters_shakespeare,
