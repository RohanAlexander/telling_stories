...
We can simulate $n=20$ draws from the Poisson distribution with `rpois()`, where $\lambda$ is the mean and here is equal to three (@fig-poissondistributiontakingshape).
