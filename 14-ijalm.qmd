...
- Linear models are a key component of statistical inference and enable us to consider a wide range of circumstance. Simple and multiple linear regression refer to the situation in which we consider some continuous dependent variable as a function of one, and multiple, independent variables, respectively. Logistic and Poisson regression are used when the dependent variable is a binary variable, and a count variable, respectively.
