...
- Prison Policy Initiative provides many [datasets](https://www.prisonpolicy.org/data/) about US prisons and jails.
...
- The World Bank provides an extensive range of [global development data](https://data.worldbank.org).
