...
1) Adding a second line to our graph. For instance, we could add inflation (@fig-notphillips). This requires us to use `pivot_longer()`, which is discussed in @sec-r-essentials, to ensure that the data are in tidy format.
