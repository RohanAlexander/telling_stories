...
1. What is a benefit of reproducibility?
...
2. According to @Alexander2019 research is reproducible if (pick one)? 
...
3. Which of the following statements best describes 'literate programming'?
...
4. What is the main function of Git in a reproducible workflow?
    a. To automate data cleaning.
    b. To run code in parallel.
    c.  To provide a version control system for code.
    d. To integrate data visualization into reports.
...
10. Assuming the packages and datasets have been loaded, what is the mistake in this code: `DoctorVisits |> filter(visits)` (pick one)?
    a.  `visits`
    b. `DoctorVisits`
    c.  `filter`
    d. `|>`
11. What is a reprex and why is it important to be able to make one (select all that apply)?
...
12. According to @sharlatalks, what is the key part of "If you need help getting unstuck, the first step is to create a reprex, or reproducible example. The goal of a reprex is to package your problematic code in such a way that other people can run it and feel your pain. Then, hopefully, they can provide a solution and put you out of your misery." (pick one)?
...
13. In the context of reproducibility, what is the function of the `renv` package?
...
14. Which of the following does NOT contribute to a reproducible workflow?
...
15. What is one advantage of using parallel processing in R?
