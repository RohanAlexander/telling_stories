...
- Read *Counting the Countless*, [@keyes2019]
  - *Discusses the difficulties of turning the world into data, in this case with respect to gender.*
- Watch *Data Science Ethics in 6 Minutes*, [@register2020].
  - *Integrates ethics and data science in a constructive way.*
- Read *What is Code?*, [@nottomford]
  - *Provides an overview of the role of code.*
