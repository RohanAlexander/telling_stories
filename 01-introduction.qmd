...
4. Imagine that you have a job in which including race and/or sexuality as predictors improves the performance of your model. When deciding whether to include these in your analysis, what factors would you consider (in your own words)?
...
7. Consider the results of a survey that asked about gender. It finds the following counts: "man: 879", "woman: 912", "non-binary: 10" "prefer not to say: 3", and "other: 1". What is the appropriate way to consider "prefer not to say" (pick one)?
    a. Drop them.
