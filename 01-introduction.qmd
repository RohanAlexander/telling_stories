...
![The workflow builds on various elements](figures/iceberg.png){#fig-iceberg width=85% fig-align="center"}
...
![This drawing is clearly a dog, even though it is just one line](figures/lump.png){#fig-lumpthedog width=85% fig-align="center"}
