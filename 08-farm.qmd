...
Incredibly, full count data, that is the entire census, are available through IPUMS for the US censuses conducted between 1850 and 1940, with the exception of 1890. Most of the 1890 census records were destroyed due to a fire in 1921. One per cent samples are available for these years, and through to 1990. And then ACS data are available from 2000.
