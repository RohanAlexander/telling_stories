...
There are a variety of sources of data that have been produced for the purposes of being used as datasets. One thinks here especially of censuses of population. @whitby [p. 30-31] describes how the earliest censuses that we have written suggestions of are from China's Yellow River valley. One motivation for censuses was taxation, and @jones1953census describes census records from the late third or early fourth century A.D. which enabled a new system of taxation. Detailed records, such as censuses, have been abused. For instance, @luebke1994locating sets out how the Nazis used censuses and police registration for data gathering.
...
With systematic sampling, as was used by @bowley1913working, we proceed by selecting some value, say 5, and we then sample every fifth unit. To begin, we randomly pick a starting point from units 1 to 5, say 3. And so sampling every fifth unit would mean looking at the third, the eighth, the thirteenth, and so on.
...
13. Please use IPUMS to access the 2020 ACS. Making use of the codebook, how many respondents were there in California (STATEICP) and had a Doctoral degree as their highest educational attainment (EDUC)?
    a.  4,684
    b. 5,765
    c. 2,007
    d. 732
