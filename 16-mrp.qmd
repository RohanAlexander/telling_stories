...
nationscape_data <-
  ...
  mutate(
    age_group = case_when(
      # case_when works in order and exits when there's a match
      age <= 29 ~ "age_18-29",
      age <= 44 ~ "age_30-44",
      age <= 59 ~ "age_45-59",
