...
- Make a GitHub repo, then make a local copy, make some changes, and push.
...
- Explain, with reference to examples, what is an estimand?
- Please pick one of---selection bias, estimator--- and include the definition in a sentence in the same way that  @monicababynames does for the Gini coefficient.
