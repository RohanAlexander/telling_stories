...
#| tbl-cap: "Members of the Beatles and the Spice Girls and their associated birth year"

tibble(
  band = c(rep("Beatles", 3), rep("Spice Girls", 3), NA_character_),
  name = c(
...
```
- Please discuss sampling bias in the context of the response by Katherine Rundell, a fellow at All Souls College, in response to a question about whether the word "emancipation" is from the  John Donne: 
